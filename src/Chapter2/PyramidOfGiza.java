...
public class PyramidOfGiza {
        public static void main(String [] args) {
            ...
            System.out.printf("Time taken to buld pyramid of Giza in years: %d%s%n%n", years, " years");
